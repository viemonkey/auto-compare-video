...
const LINES = [
  { id: "line-1", text: "Đây là Vàng nhám." },
  { id: "line-2", text: "Đây là Vàng trơn." },
  { id: "line-3", text: "Nên chọn nhẫn vàng nhám cá tính hay vàng trơn truyền thống?" },
  { id: "line-4", text: "Vàng nhám có bề mặt được đánh mờ hoặc tạo vân cát li ti, mang phong cách rất hiện đại." },
  { id: "line-5", text: "Vàng trơn sở hữu bề mặt nhẵn mịn, phản chiếu ánh sáng lấp lánh mang nét đẹp cổ điển." },
  { id: "line-6", text: "Nhẫn vàng nhám giúp che giấu các vết trầy xước nhỏ cực tốt trong quá trình đeo hàng ngày." },
  { id: "line-7", text: "Nhẫn vàng trơn rất dễ lộ vết xước dăm, nhưng bù lại cực kỳ dễ đánh bóng lại như mới." },
  { id: "line-8", text: "Tuy nhiên, bề mặt nhám dễ bám bụi bẩn vào các kẽ nhỏ và khó tự vệ sinh hơn." },
  { id: "line-9", text: "Vàng trơn láng mịn nên hầu như không bám bẩn, chỉ cần lau nhẹ là sạch bong." },
  { id: "line-10", text: "Thích cá tính hiện đại hãy chọn vàng nhám, chuộng bền bỉ truyền thống thì vàng trơn là chân ái!" },
  { id: "line-11", text: "Vàng nhám hay Vàng trơn — giờ thì bạn đã rõ rồi đấy!" },
];
