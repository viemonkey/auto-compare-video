...
const LINES = [
  ...
  { id: "line-2", text: "Đây là Kim cương." },
  { id: "line-3", text: "Làm sao phân biệt đá Moissanite và Kim cương bằng mắt thường?" },
  { id: "line-4", text: "Đá Moissanite có độ lấp lánh cực cao, phản chiếu luồng sáng cầu vồng rực rỡ dưới nắng." },
  { id: "line-5", text: "Trong khi đó, Kim cương tỏa ra ánh sáng trắng và xám thanh lịch, ít bị lóe màu sắc sặc sỡ." },
  { id: "line-6", text: "Về độ bền, Moissanite đạt chín phẩy hai mươi lăm điểm Mohs, cực kỳ khó trầy xước khi đeo." },
  { id: "line-7", text: "Nhưng kim cương tự nhiên mới là vua độ cứng với điểm mười tuyệt đối, bền bỉ vĩnh cửu." },
  { id: "line-8", text: "Điểm cộng lớn của Moissanite là mức giá cực kỳ dễ chịu, chỉ bằng một phần mười kim cương." },
  { id: "line-9", text: "Còn kim cương tự nhiên lại mang giá trị độc bản cao, giữ giá tốt và thể hiện đẳng cấp." },
  { id: "line-10", text: "Nếu thích lấp lánh giá tốt hãy chọn Moissanite, còn muốn giá trị vĩnh cửu thì chọn kim cương nhé!" },
  { id: "line-11", text: "Đá Moissanite hay Kim cương — giờ thì bạn đã rõ rồi đấy!" },
];
