...
const LINES = [
  { id: "line-1", text: "Đây là Bạc 925." },
  { id: "line-2", text: "Đây là Bạch kim." },
  { id: "line-3", text: "Nhìn giống nhau nhưng Bạc 925 và Bạch kim khác xa thế này đây!" },
  { id: "line-4", text: "Bạc 925 chứa 92.5% bạc nguyên chất, pha thêm hợp kim để tăng độ cứng." },
  { id: "line-5", text: "Bạch kim hay Platinum là kim loại quý hiếm nguyên chất tới 95%, cực kỳ bền bỉ." },
  { id: "line-6", text: "Bạc 925 rất dễ bị xỉn đen, hóa mờ sau một thời gian đeo do phản ứng với lưu huỳnh." },
  { id: "line-7", text: "Bạch kim hoàn toàn không bị oxy hóa, giữ nguyên độ sáng bóng vĩnh cửu bất chấp thời gian." },
  { id: "line-8", text: "Khi đeo, bạc 925 cho cảm giác rất nhẹ nhàng, thoải mái vì mật độ kim loại thấp." },
  { id: "line-9", text: "Bạch kim nặng và đầm tay hơn hẳn, mang lại cảm giác sang trọng, cao cấp rõ rệt." },
  { id: "line-10", text: "Bạc 925 có giá học sinh sinh viên, còn bạch kim là dòng trang sức xa xỉ đắt đỏ bậc nhất." },
  { id: "line-11", text: "Bạc 925 hay Bạch kim — giờ thì bạn đã rõ rồi đấy!" },
];
