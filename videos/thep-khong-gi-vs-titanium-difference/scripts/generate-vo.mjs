...
const LINES = [
  { id: "line-1", text: "Đây là Thép không gỉ." },
  { id: "line-2", text: "Đây là Titanium." },
  { id: "line-3", text: "Nhẫn thép không gỉ và nhẫn titan khác nhau thế nào?" },
  { id: "line-4", text: "Thép không gỉ mang lại cảm giác đầm tay, nặng hơn rõ rệt khi bạn đeo trên ngón tay." },
  { id: "line-5", text: "Trong khi đó, titanium siêu nhẹ, nhẹ hơn thép tới bốn mươi lăm phần trăm, đeo thoải mái như không." },
  { id: "line-6", text: "Về màu sắc, thép không gỉ có ánh bạc sáng loáng, phản chiếu ánh sáng cực kỳ bắt mắt." },
  { id: "line-7", text: "Còn titanium lại sở hữu tông màu xám tối hơn, bề mặt lì mờ mang phong cách cổ điển, mạnh mẽ." },
  { id: "line-8", text: "Nhẫn thép có mức giá cực kỳ bình dân, là lựa chọn hoàn hảo để thay đổi phụ kiện hàng ngày." },
  { id: "line-9", text: "Titanium tuy đắt hơn nhưng hoàn toàn không gây dị ứng da và chống ăn mòn tuyệt đối, kể cả với nước biển." },
  { id: "line-10", text: "Thép không gỉ hay Titanium — giờ thì bạn đã rõ rồi đấy!" },
];
