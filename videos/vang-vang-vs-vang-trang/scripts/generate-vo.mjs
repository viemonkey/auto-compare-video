...
const LINES = [
  ...
  { id: "line-3", text: "Nên chọn nhẫn Vàng Vàng hay Vàng Trắng?" },
  { id: "line-4", text: "Cùng là vàng nhưng sắc thái mang lại phong cách hoàn toàn khác biệt!" },
  { id: "line-5", text: "Vàng vàng mang vẻ đẹp cổ điển, ấm áp và cực kỳ tôn da ấm châu Á." },
  { id: "line-6", text: "Vàng trắng lại hiện đại, thời thượng và tôn lên độ lấp lánh của đá." },
  { id: "line-7", text: "Vàng vàng rất bền màu, không cần xi mạ lại sau thời gian dài đeo." },
  { id: "line-8", text: "Vàng trắng cần xi mạ Rhodium định kỳ để giữ vẻ sáng bóng nguyên bản." },
  { id: "line-9", text: "Nếu thích kim cương nổi bật nhất, vàng trắng là sự kết hợp tuyệt vời." },
  { id: "line-10", text: "Bạn sẽ chọn nét truyền thống ấm áp hay sự hiện đại kiêu sa này?" },
  { id: "line-11", text: "Vàng Vàng hay Vàng Trắng — giờ thì bạn đã rõ rồi đấy!" },
];
