...
const LINES = [
  ...
  { id: "line-3", text: "Nên chọn trang sức Vàng Vàng hay Vàng Trắng?" },
  { id: "line-4", text: "Vàng vàng mang sắc ấm tự nhiên, được tạo ra bằng cách pha trộn vàng nguyên chất với đồng và bạc." },
  { id: "line-5", text: "Trong khi đó, vàng trắng có màu sáng bạc hiện đại nhờ kết hợp vàng nguyên chất với palladium hoặc niken." },
  { id: "line-6", text: "Vàng vàng rất tôn da ngăm hoặc ấm, mang lại vẻ đẹp sang trọng, truyền thống và không sợ lỗi mốt." },
  { id: "line-7", text: "Còn vàng trắng cực kỳ hợp với tông da lạnh, tạo cảm giác trẻ trung, thời thượng và dễ phối đồ." },
  { id: "line-8", text: "Vàng trắng thường được phủ thêm lớp Rhodium để tăng độ sáng bóng, nhưng cần xi mạ lại sau vài năm." },
  { id: "line-9", text: "Cả hai đều là những lựa chọn tuyệt vời để tôn vinh vẻ đẹp và giá trị bền vững của bạn." },
  { id: "line-10", text: "Vàng Vàng hay Vàng Trắng — giờ thì bạn đã rõ rồi đấy!" },
];
