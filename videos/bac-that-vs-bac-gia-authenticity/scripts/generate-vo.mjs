...
const LINES = [
  { id: "line-1", text: "Đây là Bạc thật." },
  { id: "line-2", text: "Đây là Bạc giả." },
  { id: "line-3", text: "Mẹo phân biệt bạc thật và bạc giả cực dễ ai cũng làm được!" },
  { id: "line-4", text: "Bạc thật thường được khắc các ký hiệu tiêu chuẩn như S925 hoặc 950 ở mặt trong của nhẫn." },
  { id: "line-5", text: "Bạc giả hoặc mỹ ký giá rẻ thường không có ký hiệu này, hoặc nét chữ rất mờ và nhòe." },
  { id: "line-6", text: "Bạc thật nguyên chất hoàn toàn không bị nam châm hút vì kim loại này không có từ tính." },
  { id: "line-7", text: "Bạc giả chứa nhiều sắt hoặc niken bên trong sẽ bị nam châm hút chặt ngay lập tức." },
  { id: "line-8", text: "Khi thả rơi xuống nền gạch, bạc thật phát ra âm thanh trầm đục và không vang xa." },
  { id: "line-9", text: "Ngược lại, bạc giả làm từ inox hoặc đồng thau sẽ phát ra tiếng kêu đanh và chói tai." },
  { id: "line-10", text: "Bạc thật dùng lâu sẽ bị xỉn đen do phản ứng hóa học, nhưng đánh bóng lại sáng như mới." },
  { id: "line-11", text: "Bạc thật hay Bạc giả — giờ thì bạn đã rõ rồi đấy!" },
];
