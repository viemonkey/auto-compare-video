...
const LINES = [
  ...
  { id: "line-3", text: "Nên chọn Moissanite hay Kim cương để không lãng phí tiền?" },
  { id: "line-4", text: "Moissanite có giá cực kỳ dễ chịu, chỉ bằng khoảng một phần mười so với kim cương." },
  { id: "line-5", text: "Kim cương có độ cứng tuyệt đối mười trên mười, bền bỉ truyền đời không lo trầy xước." },
  { id: "line-6", text: "Moissanite phản xạ ánh sáng mạnh hơn, tạo ra luồng lửa cầu vồng cực kỳ rực rỡ." },
  { id: "line-7", text: "Ngược lại, kim cương có ánh sáng trắng thanh lịch, sang trọng và không bị quá chói." },
  { id: "line-8", text: "Nhược điểm của Moissanite là dễ bám dầu mỡ từ mồ hôi tay, nhanh mờ nếu không lau chùi." },
  { id: "line-9", text: "Tóm lại, chọn Moissanite để tối ưu chi phí, chọn kim cương để giữ giá trị đầu tư lâu dài." },
  { id: "line-10", text: "Đá Moissanite hay Kim cương — giờ thì bạn đã rõ rồi đấy!" },
];
