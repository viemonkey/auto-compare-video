...
- **Chủ đề**: So sánh Kim cương vs Moissanite.
- **Câu hỏi mở đầu (question beat, = title Gemini)**: Nhìn lướt qua giống hệt nhau, nhưng đây là hai loại đá khác biệt!
- **Sinh lúc**: 2026-09-15T02:16:09.522Z
...
1. Kim cương tự nhiên được cấu tạo hoàn toàn từ carbon, hình thành sâu trong lòng đất hàng tỷ năm. _(pose: `explain-a`)_
2. Còn Moissanite thực chất là khoáng vật Silicon Carbide, hầu hết hiện nay đều được tổng hợp nhân tạo. _(pose: `explain-b`)_
3. Kim cương giữ ngôi vương về độ cứng với điểm 10 tuyệt đối trên thang đo Mohs, không thể bị trầy xước. _(pose: `point-up-left`)_
4. Moissanite bám sát nút với độ cứng 9.25, cực kỳ bền bỉ và chỉ chịu thua mỗi kim cương. _(pose: `point-up-right`)_
5. Kim cương phản xạ ánh sáng trắng thanh lịch, lấp lánh tự nhiên và không bị quá chói mắt. _(pose: `explain-a`)_
6. Trong khi đó, Moissanite có độ khúc xạ kép, tạo ra hiệu ứng lấp lánh cầu vồng cực mạnh dưới nắng. _(pose: `shocked-a`)_
7. Về giá cả, Moissanite chỉ bằng khoảng một phần mười so với kim cương tự nhiên cùng kích thước. _(pose: `shrug-a`)_

## Ảnh minh hoạ ngữ cảnh (Giai đoạn 1 — sinh bằng Gemini image gen)

- point 4 (card `left`): `assets/images/context-4.png` — concept: "carbon atoms forming diamond crystal structure deep under the earth crust with high pressure"
