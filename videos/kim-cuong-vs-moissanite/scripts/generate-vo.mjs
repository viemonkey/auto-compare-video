...
const LINES = [
  ...
  { id: "line-2", text: "Đây là Moissanite." },
  { id: "line-3", text: "Nhìn lướt qua giống hệt nhau, nhưng đây là hai loại đá khác biệt!" },
  { id: "line-4", text: "Kim cương tự nhiên được cấu tạo hoàn toàn từ carbon, hình thành sâu trong lòng đất hàng tỷ năm." },
  { id: "line-5", text: "Còn Moissanite thực chất là khoáng vật Silicon Carbide, hầu hết hiện nay đều được tổng hợp nhân tạo." },
  { id: "line-6", text: "Kim cương giữ ngôi vương về độ cứng với điểm 10 tuyệt đối trên thang đo Mohs, không thể bị trầy xước." },
  { id: "line-7", text: "Moissanite bám sát nút với độ cứng 9.25, cực kỳ bền bỉ và chỉ chịu thua mỗi kim cương." },
  { id: "line-8", text: "Kim cương phản xạ ánh sáng trắng thanh lịch, lấp lánh tự nhiên và không bị quá chói mắt." },
  { id: "line-9", text: "Trong khi đó, Moissanite có độ khúc xạ kép, tạo ra hiệu ứng lấp lánh cầu vồng cực mạnh dưới nắng." },
  { id: "line-10", text: "Về giá cả, Moissanite chỉ bằng khoảng một phần mười so với kim cương tự nhiên cùng kích thước." },
  { id: "line-11", text: "Kim cương hay Moissanite — giờ thì bạn đã rõ rồi đấy!" },
];
