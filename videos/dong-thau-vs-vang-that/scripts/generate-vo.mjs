...
const LINES = [
  { id: "line-1", text: "Đây là Đồng thau." },
  { id: "line-2", text: "Đây là Vàng thật." },
  { id: "line-3", text: "Làm sao phân biệt nhẫn đồng thau và nhẫn vàng thật?" },
  { id: "line-4", text: "Nhìn bề ngoài hai chiếc nhẫn này giống hệt nhau, nhưng giá trị lại chênh lệch cả ngàn lần." },
  { id: "line-5", text: "Đồng thau thực chất là hợp kim của đồng và kẽm, có màu vàng sáng bóng rất đẹp." },
  { id: "line-6", text: "Còn vàng thật là kim loại quý hiếm, có độ bền hóa học cực cao và không bị oxy hóa." },
  { id: "line-7", text: "Đồng thau sau một thời gian đeo sẽ bị xỉn màu, hóa xanh do phản ứng với mồ hôi." },
  { id: "line-8", text: "Vàng thật thì vĩnh cửu, không bao giờ bị đen hay gỉ sét dù đeo hàng chục năm." },
  { id: "line-9", text: "Để phân biệt nhanh, bạn có thể dùng nam châm hoặc thử bằng axit nitric để xem phản ứng." },
  { id: "line-10", text: "Đồng thau hay Vàng thật — giờ thì bạn đã rõ rồi đấy!" },
];
