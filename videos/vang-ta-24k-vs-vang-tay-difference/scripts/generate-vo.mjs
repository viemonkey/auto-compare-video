...
const LINES = [
  { id: "line-1", text: "Đây là Vàng Ta (24K)." },
  { id: "line-2", text: "Đây là Vàng Tây." },
  { id: "line-3", text: "Phân biệt Vàng Tây và Vàng Ta cực dễ cho người mới!" },
  { id: "line-4", text: "Vàng ta là vàng tinh khiết đến chín mươi chín phẩy chín mươi chín phần trăm." },
  { id: "line-5", text: "Vàng tây là hợp kim của vàng nguyên chất pha trộn với các kim loại khác." },
  { id: "line-6", text: "Vì quá nguyên chất nên vàng ta rất mềm, dễ bị móp méo khi va đập." },
  { id: "line-7", text: "Vàng tây cứng cáp hơn nhiều, giúp giữ form tốt và dễ đính đá quý." },
  { id: "line-8", text: "Vàng ta thường được đúc thành miếng hoặc nhẫn tròn trơn để tích trữ sinh lời." },
  { id: "line-9", text: "Vàng tây đa dạng màu sắc, cực kỳ phù hợp để làm trang sức đeo hàng ngày." },
  { id: "line-10", text: "Tóm lại, mua tích trữ thì chọn vàng ta, còn đeo thời trang thì chọn vàng tây nhé!" },
  { id: "line-11", text: "Vàng Ta (24K) hay Vàng Tây — giờ thì bạn đã rõ rồi đấy!" },
];
