...
const LINES = [
  { id: "line-1", text: "Đây là Moissanite." },
  { id: "line-2", text: "Đây là Kim cương." },
  { id: "line-3", text: "Làm sao phân biệt Kim cương và Moissanite cực chuẩn?" },
  { id: "line-4", text: "Moissanite lấp lánh cực mạnh với luồng ánh sáng cầu vồng rực rỡ dưới nắng." },
  { id: "line-5", text: "Trong khi đó, kim cương tỏa ra ánh sáng trắng và xám thanh lịch, dịu mắt hơn." },
  { id: "line-6", text: "Về độ cứng, Moissanite đạt chín phẩy hai lăm trên thang Mohs, cực kỳ bền bỉ." },
  { id: "line-7", text: "Nhưng kim cương vẫn là vua độ cứng với điểm mười tuyệt đối, không thể bị trầy." },
  { id: "line-8", text: "Moissanite có mức giá cực kỳ dễ chịu, chỉ bằng một phần mười kim cương tự nhiên." },
  { id: "line-9", text: "Còn kim cương tự nhiên có giá trị tích trữ cao và biểu trưng cho sự vĩnh cửu." },
  { id: "line-10", text: "Nếu thích lấp lánh giá tốt chọn Moissanite, thích đẳng cấp vĩnh cửu chọn kim cương nhé!" },
  { id: "line-11", text: "Moissanite hay Kim cương — giờ thì bạn đã rõ rồi đấy!" },
];
