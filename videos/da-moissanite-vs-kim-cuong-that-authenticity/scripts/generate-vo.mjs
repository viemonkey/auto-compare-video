...
const LINES = [
  ...
  { id: "line-2", text: "Đây là Kim cương thật." },
  { id: "line-3", text: "Làm sao phân biệt kim cương thật và đá giả Moissanite chỉ bằng mắt thường?" },
  { id: "line-4", text: "Moissanite phản chiếu ánh sáng cực mạnh, tạo ra luồng lửa cầu vồng rực rỡ dưới ánh nắng." },
  { id: "line-5", text: "Trong khi kim cương thật tỏa ra ánh sáng lấp lánh thiên về tông trắng và xám thanh lịch." },
  { id: "line-6", text: "Nhìn qua kính lúp, Moissanite có hiện tượng khúc xạ kép khiến các đường cạnh giác cắt bị nhân đôi." },
  { id: "line-7", text: "Kim cương chỉ có khúc xạ đơn, nên các đường cạnh bên trong luôn sắc nét, không bao giờ bị bóng đôi." },
  { id: "line-8", text: "Mẹo nhanh: Hà hơi vào đá, kim cương thật tản nhiệt siêu nhanh sẽ bay hơi ngay, còn đá giả bị mờ lâu hơn." },
  { id: "line-9", text: "Để chắc chắn nhất, hãy dùng bút thử độ dẫn nhiệt hoặc yêu cầu giấy kiểm định GIA chuẩn quốc tế nhé!" },
  { id: "line-10", text: "Đá Moissanite hay Kim cương thật — giờ thì bạn đã rõ rồi đấy!" },
];
