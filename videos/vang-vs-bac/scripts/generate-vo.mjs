...
const LINES = [
  { id: "line-1", text: "Đây là Vàng." },
  { id: "line-2", text: "Đây là Bạc." },
  { id: "line-3", text: "Nên mua trang sức Vàng hay Bạc để vừa đẹp vừa giữ giá?" },
  { id: "line-4", text: "Vàng là kim loại quý hiếm, biểu tượng cho sự sang trọng và cực kỳ bền màu." },
  { id: "line-5", text: "Bạc mang vẻ đẹp trẻ trung nhưng dễ bị xỉn màu khi tiếp xúc với mồ hôi." },
  { id: "line-6", text: "Vàng có khả năng tích trữ giá trị cực tốt, là kênh trú ẩn tài sản an toàn." },
  { id: "line-7", text: "Bạc có giá thành mềm hơn nhiều, giúp bạn dễ dàng thay đổi theo xu hướng." },
  { id: "line-8", text: "Hãy chọn vàng nếu muốn tích lũy, và chọn bạc để thoải mái phối đồ thời trang." },
  { id: "line-9", text: "Vàng hay Bạc — giờ thì bạn đã rõ rồi đấy!" },
];
