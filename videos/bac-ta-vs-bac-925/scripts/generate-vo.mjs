...
const LINES = [
  { id: "line-1", text: "Đây là Bạc Ta." },
  { id: "line-2", text: "Đây là Bạc 925." },
  { id: "line-3", text: "Bạc ta và Bạc 925: Loại nào dễ xỉn màu và bền hơn?" },
  { id: "line-4", text: "Bạn có biết bạc ta và bạc 925 loại nào thực sự bền và ít bị xỉn màu hơn không?" },
  { id: "line-5", text: "Bạc ta chứa tới chín mươi chín phẩy chín phần trăm bạc nguyên chất, rất mềm và dễ biến dạng." },
  { id: "line-6", text: "Bạc chín hai lăm pha thêm bảy phẩy năm phần trăm kim loại khác giúp tăng độ cứng vượt trội." },
  { id: "line-7", text: "Về độ xỉn màu, bạc ta cực kỳ bền màu, khó bị đen hơn nhờ độ tinh khiết cao." },
  { id: "line-8", text: "Ngược lại, bạc chín hai lăm dễ bị xỉn đen hơn do các hợp kim phản ứng với lưu huỳnh." },
  { id: "line-9", text: "Hãy chọn bạc ta để giữ giá trị, và chọn bạc chín hai lăm nếu muốn chế tác tinh xảo nhé!" },
  { id: "line-10", text: "Bạc Ta hay Bạc 925 — giờ thì bạn đã rõ rồi đấy!" },
];
