...
const LINES = [
  { id: "line-1", text: "Đây là Vàng Ta." },
  { id: "line-2", text: "Đây là Vàng Tây." },
  { id: "line-3", text: "Vàng Ta và Vàng Tây khác nhau thế nào mà ai cũng nhầm?" },
  { id: "line-4", text: "Vàng ta hay vàng 24K chứa tới chín mươi chín phẩy chín mươi chín phần trăm vàng nguyên chất." },
  { id: "line-5", text: "Còn vàng tây là hợp kim giữa vàng nguyên chất và các kim loại khác như bạc, đồng hay niken." },
  { id: "line-6", text: "Vì quá nguyên chất nên vàng ta rất mềm, dễ bị móp méo và khó chế tác trang sức tinh xảo." },
  { id: "line-7", text: "Ngược lại, vàng tây rất cứng cáp, dễ đính đá quý và tạo ra nhiều kiểu dáng hiện đại." },
  { id: "line-8", text: "Vàng ta giữ giá cực tốt, là lựa chọn hoàn hảo để tích trữ lâu dài hoặc làm của hồi môn." },
  { id: "line-9", text: "Vàng tây lại thiên về giá trị thẩm mỹ, giúp bạn dễ dàng phối đồ và tỏa sáng hàng ngày." },
  { id: "line-10", text: "Tóm lại, mua để đầu tư tích trữ thì chọn vàng ta, còn muốn đeo đẹp thời trang thì cứ vàng tây nhé!" },
  { id: "line-11", text: "Vàng Ta hay Vàng Tây — giờ thì bạn đã rõ rồi đấy!" },
];
