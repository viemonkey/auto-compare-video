...
const LINES = [
  { id: "line-1", text: "Đây là Kim cương nhân tạo." },
  { id: "line-2", text: "Đây là Kim cương tự nhiên." },
  { id: "line-3", text: "Mẹo phân biệt kim cương tự nhiên và nhân tạo cực dễ bằng mắt thường!" },
  { id: "line-4", text: "Nhìn bằng mắt thường, hai viên đá này trông lấp lánh cực kỳ giống nhau đúng không?" },
  { id: "line-5", text: "Kim cương nhân tạo hoặc đá giả thường phản chiếu ánh sáng ra sắc cầu vồng rất rực rỡ." },
  { id: "line-6", text: "Trong khi kim cương tự nhiên chủ yếu tỏa ra ánh sáng màu xám và trắng cực kỳ tinh tế." },
  { id: "line-7", text: "Mẹo nhỏ là hãy hà hơi vào viên đá, loại nhân tạo giữ nhiệt kém nên hơi nước bám lâu." },
  { id: "line-8", text: "Còn kim cương tự nhiên dẫn nhiệt siêu tốt, hơi sương sẽ tan biến ngay lập tức." },
  { id: "line-9", text: "Để chắc chắn nhất, bạn hãy luôn yêu cầu người bán cung cấp giấy kiểm định GIA nhé!" },
  { id: "line-10", text: "Kim cương nhân tạo hay Kim cương tự nhiên — giờ thì bạn đã rõ rồi đấy!" },
];
