...
const LINES = [
  { id: "line-1", text: "Đây là Phô mai kem." },
  { id: "line-2", text: "Đây là Phô mai tươi." },
  { id: "line-3", text: "Phô mai kem và phô mai tươi khác nhau thế nào?" },
  { id: "line-4", text: "Phô mai kem được làm từ sữa và kem tươi, vị chua béo ngậy đặc trưng." },
  { id: "line-5", text: "Phô mai tươi như Burrata làm từ sữa đông, cực kỳ mọng nước và thanh mát." },
  { id: "line-6", text: "Cream cheese có kết cấu đặc mịn, dễ tán, là linh hồn của bánh cheesecake." },
  { id: "line-7", text: "Phô mai tươi có lớp vỏ dai nhẹ, bên trong là kem béo ngậy tan chảy." },
  { id: "line-8", text: "Hàm lượng béo của phô mai kem rất cao, thường chiếm trên ba mươi phần trăm." },
  { id: "line-9", text: "Phô mai tươi vị nhẹ nhàng hơn, cực hợp khi ăn kèm salad và dầu ô-liu." },
  { id: "line-10", text: "Cả hai đều là phô mai không ủ chín, nên ăn ngay để giữ vị ngon nhất!" },
  { id: "line-11", text: "Phô mai kem hay Phô mai tươi — giờ thì bạn đã rõ rồi đấy!" },
];
