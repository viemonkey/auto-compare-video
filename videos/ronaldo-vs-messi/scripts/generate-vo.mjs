...
const LINES = [
  { id: "line-1", text: "Đây là Ronaldo." },
  { id: "line-2", text: "Đây là Messi." },
  { id: "line-3", text: "Ronaldo và Messi: Ai mới là GOAT thực sự của bóng đá thế giới?" },
  { id: "line-4", text: "Ronaldo nổi bật với thể hình lý tưởng, sức bật phi thường và khả năng dứt điểm toàn diện." },
  { id: "line-5", text: "Messi lại sở hữu trọng tâm thấp, kỹ thuật rê bóng lắt léo thiên tài và nhãn quan kiến tạo đỉnh cao." },
  { id: "line-6", text: "CR7 là biểu tượng của sự khổ luyện phi thường, duy trì phong độ đỉnh cao nhờ kỷ luật thép." },
  { id: "line-7", text: "El Pulga mang vẻ đẹp của tài năng thiên bẩm, chơi bóng thanh thoát và ngẫu hứng như một nghệ sĩ." },
  { id: "line-8", text: "Ronaldo sở hữu kỷ lục ghi bàn vĩ đại nhất lịch sử và vô số danh hiệu Champions League." },
  { id: "line-9", text: "Messi đã hoàn tất bộ sưu tập vĩ đại với chức vô địch World Cup và 8 Quả bóng Vàng." },
  { id: "line-10", text: "Cả hai tạo nên kỷ nguyên cạnh tranh vĩ đại nhất, thúc đẩy nhau vượt qua mọi giới hạn." },
  { id: "line-11", text: "Ronaldo hay Messi — giờ thì bạn đã rõ rồi đấy!" },
];
