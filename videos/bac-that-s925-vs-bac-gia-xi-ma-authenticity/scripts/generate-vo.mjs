...
const LINES = [
  { id: "line-1", text: "Đây là Bạc thật (S925)." },
  { id: "line-2", text: "Đây là Bạc giả / Xi mạ." },
  { id: "line-3", text: "Mẹo phân biệt bạc thật và bạc giả cực dễ tại nhà!" },
  { id: "line-4", text: "Bạc thật thường có khắc ký hiệu tiêu chuẩn như S925 hoặc 925 ở mặt trong." },
  { id: "line-5", text: "Bạc giả hoặc trang sức mỹ ký giá rẻ thường trơn láng, không có bất kỳ ký hiệu kiểm định nào." },
  { id: "line-6", text: "Bạn có thể thử bằng nam châm, bạc thật nguyên chất hoàn toàn không bị hút." },
  { id: "line-7", text: "Ngược lại, bạc giả pha nhiều sắt hoặc kim loại nặng sẽ bị nam châm hút chặt ngay lập tức." },
  { id: "line-8", text: "Khi thả rơi xuống nền gạch, bạc thật phát ra âm thanh trầm, đục và không vang xa." },
  { id: "line-9", text: "Còn các loại inox, sắt giả bạc khi rơi sẽ kêu 'loảng xoảng' rất đanh và vang." },
  { id: "line-10", text: "Để chắc chắn nhất, bạn hãy mang ra tiệm dùng nước phổ hoặc máy đo quang phổ nhé!" },
  { id: "line-11", text: "Bạc thật (S925) hay Bạc giả / Xi mạ — giờ thì bạn đã rõ rồi đấy!" },
];
